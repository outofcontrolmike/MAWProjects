 ...
 imgArray[35].src = "img/hikes/wilson3.jpg";
  ...
  let hikes = [
    ...
    //Wilson's Creek
    {
      ...
      dogFriendly: "They are not allowed in buildings. Dogs must be leashed and under their owner's control at all times.",
  ...
  return (
    <div className="ui" id="hikesText" style={{  color: "black", height: "100vh" }}>
      <HikeHeader />
      <HikeNavigation />
