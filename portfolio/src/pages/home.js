...
function Home() {
    ...
    return(
        ...
        <div className="ui" style={{backgroundColor: "black"}}>
            ...
            <a className="item">
                        <Link to="/resume">                 <h1 style={{paddingTop:"2rem"}}>Resume</h1>
            ...
            <div className="ui two column grid">
                ...
                <div className="ui column">
                <a className="item">
                        <Link to="/projects"> <h1>Projects</h1>
</Link>
                    </a>                    </div>  
            </div>
            ...
            <div className="ui two column grid">
                <div className="ui column">
                    <a className="item">
          <Link to="/"><h1 style={{textAlign:"left"}} >Home</h1></Link>
        </a>
           
                </div>
                <div className="ui column">
                <a className="item">
          <Link to="/contact"><h1 style={{textAlign:"right"}}>Contact</h1></Link>
        </a>
                    </div>  
            </div>
            <div className="ui three column grid stackable">
                ...
                <div className="ui column">
                    <h1>Image of me will go here</h1>
                    </div>  
                    <div className="ui column">
