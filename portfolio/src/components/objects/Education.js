      ...
      >
        ...
        <div className="ui two column stackable grid fluid very padded">
          ...
          <div className="ui column">
            ...
            <p>
              <span className="ui text medium">
                I mostly took general education courses due to the possibility
                of transferring to Missouri State University. I also studied
                Culinary Arts and Automotive Engineering for a couple semesters.
              </span>
            </p>
          </div>
        </div>
