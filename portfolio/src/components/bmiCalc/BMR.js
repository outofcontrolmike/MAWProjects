        ...
        <hr/>
          ...
          <div className="three fields">
            <div className="field">
              ...
              <input id="bmrHeight" placeholder="Height" type="tel" maxlength="2" />
            </div>
            <div className="field">
              <label>Weight (lbs)</label>
              <input id="bmrWeight" placeholder="Weight" type="text" maxLength="3" />
            </div>
            <div className="field">
              <label id="bmi">Age</label>
              <input type="tel" maxlength="2" id="" maxlength="3" max="110" placeholder='Age' id="bmrAge" />                        </div>
          </div>
          <div className='two fields'>
            ...
            <div className="field">
            <span className="ui"> <button className="ui button" id="bmrCalc" style={{marginTop: "1.8rem"}} >Calculate BMI</button></span>
            </div>
          </div>
          <div className='field'>
