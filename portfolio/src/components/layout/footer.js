          ...
          <div className="ui center aligned container">
            <div className="ui stackable inverted divided grid">
              <div className="three wide column">
                <h4 className="ui inverted header">Resources Used</h4>
              ...
              <div className="three wide column">
                <h4 className="ui inverted header">Projects</h4>
                <div className="ui inverted link list">
              ...
              <div className="three wide column">
                <h4 className="ui inverted header">Projects Extended</h4>
                <div className="ui inverted link list">
              ...
              <div className="seven wide column">
                <h4 className="ui inverted header">Quick Contact</h4>
