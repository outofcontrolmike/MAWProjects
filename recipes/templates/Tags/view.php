                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <?= $this->Html->link(__('View'), ['controller' => 'Recipes', 'action' => 'view', $recipes->title]) ?>
                                <?= $this->Html->link(__('Edit'), ['controller' => 'Recipes', 'action' => 'edit', $recipes->title]) ?>
                                <?= $this->Form->postLink(__('Delete'), ['controller' => 'Recipes', 'action' => 'delete', $recipes->title], ['confirm' => __('Are you sure you want to delete {0} ?', $recipes->title)]) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
