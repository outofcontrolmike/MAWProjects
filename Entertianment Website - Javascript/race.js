...
function startRace() 
{
     ...
     stopLight = document.getElementById('star').src = "imagesGreatRace/on.png";
     marioRun = document.getElementById('mario').src = "imagesGreatRace/mariorun.png";
     yoshiRun = document.getElementById('yoshi').src = "imagesGreatRace/yoshirun.png";
...
function revealImages()
{
    ...
    document.getElementById('star').src="imagesGreatRace/off.png";
...
{
    document.getElementById('mario').src = "imagesGreatRace/mariorun.png";
     document.getElementById('yoshi').src = "imagesGreatRace/yoshirun.png";
     document.getElementById('star').src = "imagesGreatRace/on.png";
     document.getElementById('mario').style.left = "0px";
     document.getElementById('yoshi').style.left = "0px";
